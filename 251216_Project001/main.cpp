...
int main() {
  ...
  while (inputSelection != 0) {
    ...
    case 5:
      ...
      DebugPrinter::printAttributeIncrease(
        resultGet, 4, attributePoint, plStats);
      break;
    case 6:
      resultGet = plStats.addOneStat(5, &attributePoint);
      DebugPrinter::printAttributeIncrease(
        resultGet, 5, attributePoint, plStats);
      break;
    case 7:
      resultGet = plStats.addOneStat(6, &attributePoint);
      DebugPrinter::printAttributeIncrease(
        resultGet, 6, attributePoint, plStats);
      break;
    case 8:
      DebugPrinter::printOverallState(
